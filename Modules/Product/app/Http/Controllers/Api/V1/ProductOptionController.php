...
final class ProductOptionController extends Controller
{
    ...
    public function updateItem(UpdateProductOptionWithItemRequest $request, string $id): JsonResponse
    {

        try {

            $res = $this->productOptionService->updateOptionItems($request, $id);
